...
st.header("Priorizador de Tareas")
st.write("Clasifica todas tus tareas de acuerdo a la Matriz de Heinsehower.")
st.divider()

# Input del ROL (Movido arriba de la lista como pediste)
user_role = st.text_input(
    "👤 ¿Cuál es tu cargo o rol?", 
    value="Profesional ocupado",
    placeholder="Ej: Gerente de Ventas, Abogado, Dueña de casa..."
)

# Input de TAREAS
st.subheader("Lista de tareas pendientes")
tasks_input = st.text_area(
    "Ingresa tus tareas aquí (una por línea):",
    height=150,
